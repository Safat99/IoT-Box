...
//  }
  ...
  if(Firebase.getString(firebaseData, "IOT-BOX/relay1")){
  ...
  if(Firebase.getString(firebaseData, "IOT-BOX/relay2")){
    Serial.println(firebaseData.stringData());
    if (firebaseData.stringData() == "1"){
  ...
  if(Firebase.getString(firebaseData, "/IOT-BOX/relay3")){
    Serial.println(firebaseData.stringData());
    if (firebaseData.stringData() == "1"){
...
//  
  if(Firebase.getString(firebaseData, "/IOT-BOX/relay4")){
    Serial.println(firebaseData.stringData());
    if (firebaseData.stringData() == "1"){
