...
(library Library_1
	...
	(patternDef "PHEONIX-5.08PITCH-2PIN" (originalName "PHEONIX-5.08PITCH-2PIN")
		(multiLayer
	...
	(compDef "1711725" (originalName "1711725") (compHeader (numPins 2) (numParts 1) (refDesPrefix IC)
		...
		(attachedPattern (patternNum 1) (patternName "PHEONIX-5.08PITCH-2PIN")
			(numPads 2)
			(padPinMap
		...
		(attr "<Hyperlink>" "http://docs-asia.electrocomponents.com/webdocs/1380/0900766b81380186.pdf")
